...
import com.github.astah.connector.backlog.updater.NotificationPopup.Position;


public class AutoUpdater {
	private static final Logger logger = LoggerFactory.getLogger(AutoUpdater.class);
	private String updateXml = "https://github.com/downloads/shoito/backlog-connector-for-astah/update.xml";
			...
			public Void handleResponse(HttpResponse response) throws ClientProtocolException, IOException {
				...
				if (versionCompareTo(updateCheck.getVersion(), getCurrentVersion()) > 0) {
	        		String message = "<html><span style='font-size: 10px;font-family: Arial, Helvetica;'>astahプラグイン更新通知</font><br>" +
	        				"<hr>" +
	        				"<span style='font-size: 9px;font-family: Arial, Helvetica;'>Backlog Connector for Astahの新しいバージョンがダウンロードできます。<br>" +
